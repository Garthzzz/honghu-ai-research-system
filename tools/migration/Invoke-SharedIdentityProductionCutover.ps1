...
# neither modified nor migrated.  With 8080 stopped, rebuild a read-only final
# source identity and require it to equal the S1 watermark before authority can
# leave SQLite.
