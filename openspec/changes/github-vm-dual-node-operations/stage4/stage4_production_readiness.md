...
| mapping | legacy id 与 stable key 唯一、source watermark 可验证 | 拒绝 mutation |
...
- [ ] stable entity mapping 对 company/industry/theme 全量验证；
- [ ] production PG topology、角色、凭据、服务和网络现场验收；
- [ ] VM 外 backup、PITR/等价增量路径、整库和旁路单域 restore 现场演练；
