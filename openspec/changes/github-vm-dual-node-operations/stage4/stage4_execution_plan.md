...
- [x] delete-first authority 修复实现提交 `ba927f66143869497be3ea6af9c9bb69439ad6ab`；治理记录不改写该实现。PR #7 继续保持 open/未合并，最终 branch head 的 push/PR required CI 在 HALT 报告中按 GitHub 实际状态核验。
